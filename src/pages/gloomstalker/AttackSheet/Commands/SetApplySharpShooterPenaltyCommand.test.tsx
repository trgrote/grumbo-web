...
describe('SetApplySharpShooterPenaltyCommand', () => {
	it('sets applySharpShooterPenalty to the constructor value', () => {
		...
		expect(new SetApplySharpShooterPenaltyCommand(true).apply(state).character.applySharpShooterPenalty).toBe(true);
		expect(new SetApplySharpShooterPenaltyCommand(false).apply(buildTestState({ applySharpShooterPenalty: true })).character.applySharpShooterPenalty).toBe(false);
	});
});
